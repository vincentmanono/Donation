...
<div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <div class="row">
                        <form action="{{ route('products.update',$product) }}" method="post" class="col-12 row" enctype="multipart/form-data" >
                            @csrf
                            @method("PUT")
                            <div class="form-group col-6 ">
                                <label for="name">Product name</label>
                                <input id="name" class="form-control" value="{{$product->name}}" type="text" name="name">
                            </div>
                            <div class="form-group col-6 ">
                            ...
                            <div class="form-group col-6 ">
                                ...
                                <input id="weight" class="form-control" value="{{$product->weight}}" type="text" name="weight">
                            </div>
                            <div class="form-group col-6 ">
                              <label for="type">Product type</label>
                              <select class="form-control" name="type" value="{{ $product->type}}" id="type">
                            ...
                            <div class="form-group col-6 ">
                                ...
                                <select id="durability" class="form-control" value="{{ $product->durability }}" name="durability">
                            ...
                            <div class="form-group col-6 ">
                                ...
                                <input id="expiry_date" class="form-control" value="{{ $product->expiry_date }}" type="datetime" name="expiry_date">
                            </div>
                            <div class="form-group col-6 ">
                            ...
                            <div class="form-group col-6 ">
                                ...
                                <option value="{{ $product->trasport }}" selected> {{ $product->transport ? "Yes":"No"}}</option>
