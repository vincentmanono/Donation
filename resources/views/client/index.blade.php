...
<div class="owl-carousel-wrapper">
  ...
  <div class="container">
    <div class="feature-29192-wrap d-md-flex" style="margin-top: -20px; position: relative; z-index: 2;">
      ...
      <a href="#" class="feature-29192 overlay-danger" style="background-image: url('/client/assets/images/img_3_gray.jpg');">
        <div class="text">
      ...
      <div class="feature-29192 overlay-warning" style="background-image: url('/client/assets/images/img_1_gray.jpg');">
        <div class="text">
        ...
        <div class="col-md-4">
            <div class="cause shadow-sm">
              ...
              <a href="#" class="cause-link d-block">
                <img src="/client/assets/images/img_1.jpg" alt="Image" class="img-fluid">
              ...
              <div class="px-3 pt-3 border-top-0 border border shadow-sm">
                ...
                <div class="py-4">
                  <div class="d-flex align-items-center">
                    <img src="/client/assets/images/person_1.jpg" alt="Image" class="rounded-circle mr-3" width="50">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="event-29191 mb-5">
            <a href="#" class="d-block mb-3"><img src="/client/assets/images/img_1.jpg" alt="Image" class="img-fluid rounded"></a>
        ...
        <div class="col-md-6">
          <div class="event-29191 mb-5">
            <a href="#" class="d-block mb-3"><img src="/client/assets/images/img_2.jpg" alt="Image" class="img-fluid rounded"></a>
            <div class="px-3 d-flex">
  ...
  <div class="site-section bg-image overlay-primary" style="background-image: url('/client/assets/images/img_1.jpg');">
    <div class="container">
      <div class="row align-items-stretch">
        <div class="col-md-6">
          <img src="/client/assets/images/img_1.jpg" alt="Image" class="img-fluid shadow">
        </div>
        <div class="col-md-6">
